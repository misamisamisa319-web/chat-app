...
"絶頂許可4.Ｍ字開脚の状態で「皆さん私のここをよく見てください」と状態を実況しながら絶頂する。",
"絶頂許可5.四つん這いで舌を出しながら「私はオナペットです。皆さん罵倒してください」と言い続けながら絶頂する。",
"絶頂許可6.玩具を持ってる場合は玩具で絶頂を3回する。持っていない場合は手で3回絶頂するまで動かし続ける。",
"絶頂許可7.マングリ返し状態で顔や胸にかけながら絶頂をする。かからない場合かかるまで行う。",
"絶頂許可8.女性はこれまで中出しされた人の人数、男性はこれまで中出しした人の人数を告白。その人数分連続絶頂する。",
"絶頂許可9.「私は変態のドMです。」と言い続けながら立ったまま立てなくなるまで絶頂をし続ける。",
"絶頂許可10.参加者の人数分絶頂するまで手を止めてはいけない。",
"絶頂許可11.これまで寸止めした回数絶頂するまで手を止めてはいけない。",
"絶頂許可12.ルブルの部屋で「絶頂許可をいただきました。誰か来るまで絶頂し続けれるので誰も入ってこないでください。」とつぶやき、絶頂しても見学者がくるまで手を動かし絶頂しつづける。",
