...
"オナ女1.乳首に触れないように乳輪を指でくるくるなぞる２分間。",
"オナ女2.乳頭を薬指でふれるかふれないかの位置で上下にスリスリする2分間。",
"オナ女3.乳頭を人差し指の爪でカリカリ2分間する。",
"オナ女4.乳首を全力で1分間ひっぱる。",
"オナ女5.乳首を親指と中指でコリコリ潰しながら人差し指でスリスリ3分間する。",
"オナ女6.乳首を親指と中指でコリコリ潰しながら人差し指の爪でカリカリ3分間する。",
"オナ女7.乳首にメンソレータムをぬって3分間塗り込む、もしない場合は愛液を塗る。",
"オナ女8.クリトリスにメンソレータムを塗って3分間塗り込む、ない場合は歯磨き粉を薄く塗る。",
"オナ女9.オマンコの入口にメンソレータムを塗って3分間塗り込む、ない場合は歯磨き粉を薄く塗る。",
"オナ女10.人差指or中指をクリトリスに当て、PCのマウスをクリックするくらいの強さでクリトリスを3分間タップする。",
"オナ女11クリトリスを指でスリスリ3分間する。.",
"オナ女12.人差し指と中指でクリトリスを軽く挟み込んでシコシコ3分間する。",
"オナ女13.中指・薬指二本の指をクリトリスに当て、時計回りに3分間スリスリする。",
"オナ女14.オマンコの中に指を入れズボズボ出し入れを３分間する。",
"オナ女15.オマンコに玩具または棒状の物をズボズボ出し入れ3分間する。",
"オナ女16.「私はドMの変態ですとつぶやきながら」頭の上で手を組んでガニ股で立った状態で腰へコ30回。",
"オナ女17.舌を出しながら四つん這いになって部屋を1周歩く、その際部屋の紹介をする。",
"オナ女18.ルブルの部屋上げをして、「見学者様あなたの指示した通りに寸止めオナニーします」とつぶやき5分間オナニーする。5分以内に見学者が来た場合、来た見学者の人数指示をしてもらい寸止めする。",
"オナ女19.玩具を持ってる場合は玩具で寸止め1回する。もってない場合は回数+2回",
"オナ女20.回数を+2回してルブルにて1d5+3のサイコロを振り「○分間全力オナニーをします」と発言し、今の心境も書き残してくること。",
"オナ女21.回数を+2回して「ドMの変態です。見学者が多いほど興奮します。是非見に来てください♡残り罰回数は〇回です」とルブルの部屋で宣伝し、誰かが来るまでクリをスリスリしつづける。",
"オナ女22.回数を+2回してルブルの部屋に玩具を全て告白して玩具で見学者がくるまでオナニーする。「例：私の持ってる玩具はローター1、バイブ1です」",
"オナ女23.ガニ股で立ったまま1回寸止めオナニーする。",
"オナ女24.直近一週間のオナニー回数を告白。その中の一つの方法で1回寸止めする。",
"オナ女25.性感帯を告白し、そこを重点的に攻めたオナニーで1回寸止めする。",
"オナ女26.オナニーの頻度と一番好きなオナニーのおかず・方法を告白する。その後、告白した方法でオナニーをして1回寸止めする。",
"オナ女27.自分が思う一番惨めで恥ずかしく感じやすいオナニーの仕方を告白し、その方法で1回寸止めする。",
"オナ女28.今まで経験した人数を告白してその回数寸止めする。",
"オナ女29.今現在入室してる人の数寸止めする。",
"オナ女30.今までやってきた回数寸止めする。"
];
