...
"女子罰30.【地獄】男性化。勝者に男性としての名前、名前の色をつけてもらう。一人称は「オレ」で女言葉使用禁止、男になりきってチャットすること。罰終了後、トイレは男性のようにガニ股で立って行い。ブラは付けない。期間は次に勝負するまで。次回勝負前にルブルにて感想を書いてから行うこと。",
];
...
"男子罰29.【地獄】女性化。勝者に女性としての名前、名前の色をつけてもらう。一人称は「あたし」で男言葉使用禁止、女になりきってチャットすること。罰終了後、100均にあるので構わないので女性用パンツを身につけるように。出来るならブラも家ではつける。おちんぽはクリ、アナルはおまんこと呼称する。オナニーする場合は普通にしごく男としてのオナニーを禁止し、女性のクリオナのように撫でるようにする。期間は次に勝負に勝するまで。次回勝負前に感想を書いてから行うこと。",
...
7: "5,指示：3分間、自分以外の誰かにオナニーを指示してもらう。居ない場合クリまたは亀頭をスリスリする。",
...
if (sugorokuCooldownByRoom[room] && now - sugorokuCooldownByRoom[room] < SUGOROKU_COOLDOWN) {
...
sugorokuCooldownByRoom[room] = now;
